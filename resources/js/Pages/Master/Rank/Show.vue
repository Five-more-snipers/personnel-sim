          ...
          <div class="card shadow-sm border-0">
            <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
              ...
              <div class="d-flex gap-2">
                <Link :href="`/ranks/${rank.id}/edit`" class="btn btn-sm btn-light">
                  <i class="bi bi-pencil"></i> Edit
                </Link>
                <Link href="/ranks" class="btn btn-sm btn-outline-light">
                  ← Back
                </Link>
              </div>
            </div>
            <div class="card-body">
              ...
              <div v-if="rank.description" class="biography-content" v-html="renderedDescription">
              </div>
            ...
            <div class="card-body">
              <ul class="list-group list-group-flush">
                <li class="list-group-item d-flex justify-content-between">
                  ...
                  <span class="fw-bold">{{ rank.personnels_count || 0 }}</span>
                </li>
              </ul>
            </div>
          </div>
...
const renderedDescription = computed(() => {
  if (!props.rank.description) return ''
  return md.render(props.rank.description)
})
</script>
