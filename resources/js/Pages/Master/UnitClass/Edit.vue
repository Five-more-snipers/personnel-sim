        ...
        <div class="col-md-8">
          <div class="card shadow-sm border-0">
            <div class="card-header bg-primary text-white">
              <h4 class="mb-0">Edit Unit Class</h4>
            </div>
            <div class="card-body bg-light">
              <form @submit.prevent="submit">
                ...
                <div class="d-flex justify-content-between mt-4 pt-3 border-top">
                  ...
                  <button type="submit" class="btn btn-primary btn-lg" :disabled="form.processing">Update Unit Class</button>
                </div>
              </form>
            </div>
          </div>
...
const props = defineProps({ unitClass: Object })
const form = useForm({ 
  name: props.unitClass.name, 
  description: props.unitClass.description || '' 
})
...
const submit = () => {
  form.put(`/unit-classes/${props.unitClass.id}`)
}
</script>