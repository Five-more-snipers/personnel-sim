              ...
              <form @submit.prevent="submit">
               ...
               <div class="mb-3">
                ...
                <div class="d-flex justify-content-between mt-4 pt-3 border-top">
                  ...
                  <button type="submit" class="btn btn-primary btn-lg" :disabled="form.processing">Update Weapon</button>
                </div>
              </form>
            </div>
          </div>
...
const form = useForm({ 
  ...
  inspiration_source: props.weapon.inspiration_source || '',
