            ...
            <div class="card-body bg-light">
              <form @submit.prevent="submit">
                ...
                <div class="mb-3">
                  ...
                  <div class="mb-2 d-flex gap-2 align-items-center">
                   ...
                   <textarea 
                    ...
                    rows="15" 
                    placeholder="Enter faction description in Markdown..."></textarea>
                ...
                <div class="d-flex justify-content-between mt-4 pt-3 border-top">
                  <Link href="/factions" class="btn btn-secondary btn-lg">Cancel</Link>
                  <button type="submit" class="btn btn-primary btn-lg" :disabled="form.processing">Update Faction</button>
                </div>
              </form>
            </div>
          </div>
...
const submit = () => {
  form.put(`/factions/${props.faction.id}`)
}
</script>